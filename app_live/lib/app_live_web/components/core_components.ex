defmodule AppLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AppLiveWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AppLiveWeb.Gettext, "errors", msg, opts)
    # end

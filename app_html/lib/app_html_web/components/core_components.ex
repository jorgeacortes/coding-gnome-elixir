defmodule AppHtmlWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AppHtmlWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AppHtmlWeb.Gettext, "errors", msg, opts)
    # end
